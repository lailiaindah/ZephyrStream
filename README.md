...
**v1.5.3** — A self-hosted automated live streaming scheduler for YouTube, built with Next.js 16, TypeScript, Prisma, and FFmpeg. Designed to be installed on a VPS and managed from any browser.
...
**ZephyrStream v1.5.3** — Built with ❤️ for the streaming community.
